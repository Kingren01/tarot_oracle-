...
def render():
    ...
    if "crewai_output" not in st.session_state:
        ...
        <div style="text-align:center; padding:80px 20px;">
            ...
            <div style="font-size:22px; font-weight:700; color:{t['accent']}; font-family:'Cinzel',serif; margin-bottom:8px;">No Research Selected</div>
            <div style="color:{t['text_secondary']}; font-size:15px; font-family:'Cormorant Garamond',serif; font-style:italic;">
                Select a report from the dashboard to review analysis details.
            </div>
        </div>
        """, unsafe_allow_html=True)
        if st.button("← Return to Research Index"):
    ...
    <div style="margin-bottom: 28px;">
        <div class='oracle-label'>✦ INTELLIGENCE REPORT ✦</div>
    ...
    with t1:
        ...
        with col1:
            ...
            st.plotly_chart(
                create_circular_gauge(ds.get("value", 0), max_val=100, title="Account Displacement Score"),
        ...
        if gaps:
            st.markdown(f"<div class='oracle-label' style='margin-bottom:12px;'>📊 Capability Gap Assessment</div>", unsafe_allow_html=True)
    ...
    with t2:
        ...
        total = len(pptx)
        if total == 0:
            st.info("No executive strategy slides available for this report.")
        else:
    ...
    with t3:
        ...
        <div style="text-align:center; margin-bottom:28px;">
            <div class='oracle-label'>📜 COMPREHENSIVE EXECUTIVE STRATEGY</div>
            <div style="font-size:14px; color:{t['text_secondary']}; font-family:'Cormorant Garamond',serif; font-style:italic; margin-top:8px;">
                The full intelligence report as generated by the AI research agents.
            </div>
        </div>
        """, unsafe_allow_html=True)

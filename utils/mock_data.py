...
mock_crewai_output = {
    ...
    "executive_powerpoint": [
        ...
        },
        {
            ...
            "content": "Our market-based displacement analysis yields an Arena Disruption Score of 86/100, placing MedLife Systems in the 'High Displacement Opportunity' category. Financial modeling based on verified industry benchmarks projects $37.4M in total ROI over 36 months, with a conservative 96% confidence interval. Year 1 alone delivers $12.5M in savings against an implementation investment of $4.1M, achieving full payback within 4 months.",
            "bullets": ["Arena Disruption Score: 86/100 (Top 5% of assessments)", "Total ROI: $37.4M over 36 months", "Year 1 Savings: $12.5M (3x implementation cost)", "Payback Period: 4 months", "Risk Avoidance Value: $5.2M", "Innovation Acceleration: 3.2x improvement"],
            "visual_recommendations": "ROI waterfall chart and disruption score gauge",
            ...
            "citations": ["IDC Cloud ROI Study 2024", "Agilisium Deployment Analytics", "Market Displacement Methodology v3.1"]
        },
        {
            "slide": 8,
